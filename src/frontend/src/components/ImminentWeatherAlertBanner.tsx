...
export function ImminentWeatherAlertBanner({
  alert,
  onDismiss,
}: ImminentWeatherAlertBannerProps) {
  const { t } = useI18n();
  ...
  return (
    <div
      className={`glass-surface-strong p-3 sm:p-4 rounded-xl border ${getSeverityStyles()}`}
    >
